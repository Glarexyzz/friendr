...
function LoganProfile() {
  const [liked, setLiked] = useState(false);
  const [disliked, setDisliked] = useState(false);

  return (
    <div className="andy-profile">
      <h1>Logan's Profile</h1>
      <div className="profile-container">
        <div className="avatar-container">
          ...
          <img src={profileIcon} alt="Logan" className="profile-avatar" />
        ...
        <div className="profile-info">
          <p><span className="label">Name:</span> Logan Miller</p>
          <p><span className="label">Age:</span> 20</p>
          <p><span className="label">Interests:</span> Guitar, Hiking, Graphic Design</p>
          <p><span className="label">University:</span> King's College London</p>
        </div>
      </div>
    </div>
  );
